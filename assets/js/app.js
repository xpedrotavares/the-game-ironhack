...
class Player {
  constructor (x, y, w, h) {
    ...
    this.img = new Image()
    this.img.src = '../images/kisspng-tyrannosaurus-t-shirt-dino-t-rex-runner-2-lonely-t-8-bit-5ac1f4e6ee15e6.3215979715226605829752.png'
...
class Obstacle {
  constructor (x, y, w, h) {
    ...
    this.h = h;
    this.img = new Image()
    this.img.src = '../images/Daco_6127748.png'
